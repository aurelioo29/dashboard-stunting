            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" wire:navigate
                        class="inline-flex items-center focus:outline-none focus:ring-2 focus:ring-indigo-500 rounded">
                        <img src="{{ asset('logo.png') }}" alt="{{ config('app.name') }} logo" class="h-10 w-auto">
                    </a>
                </div>

                <!-- Navigation Links -->
                <div class="hidden sm:-my-px sm:ms-8 sm:flex space-x-8">
